...
struct Shape16 {
	...
	void AddPoint(const float& x, const float y, const sf::Color& color1, sf::Color& color2)
	{
		sf::Vertex vert;
...
void DebugDraw::DrawTransform(const b2Transform& xf)
{
	...
	drawLine(p1.x*RATIO, p1.y*RATIO, p2.x*RATIO, p2.y*RATIO, 1, sf::Color::Red);
